...
static void mqtt5_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        // Once connection is esablished. could be good to switch to 0,0,0 since the middle 1 is more protection than i need for sensor updates
        msg_id = esp_mqtt_client_publish(client, "/kitchen/sensor", json, 0, 1, 0);
        // THIS IS WHERE I HAVE MODIFED THE POSTED DATA
...
static void mqtt5_app_start(void)
{
   ...
   /*BELOW IS MODIFIED TO CONNECT TO LOCAL MQTT MOSQUITTO BROKER*/
    ...
    const esp_mqtt_client_config_t mqtt5_cfg = {
        ...
        .broker = {
        .address.uri = "mqtt://192.168.1.240:1883",
    },
        /*.broker = {
